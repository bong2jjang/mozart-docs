...
// The static files are located in this directory: docs/static/img/who-is-using-mozart.
// Don't forget to compress your image before adding it to the directory.

const posts = [
  {
    title: 'sinzy Blogs',
    imageUrl: '/img/who-is-using-mozart/blog.sinzy.net.png',
    href: 'https://blog.sinzy.net/',
    // Description in one short sentence.
    description: 'A blog community (currently in Chinese) based on a multi-user blog system powered by Mozart'
  },
];

export default function WhoIsUsingMozart() {
  return (
    <Layout
      description='Who is using Mozart'>
      <div className="tw-px-4 tw-pt-16 tw-pb-20 sm:tw-px-6 lg:tw-px-8" style={{ backgroundColor: '#1b7cf2' }}>
        <div className="tw-mx-auto tw-max-w-7xl">
          <div className="tw-text-center">
            <h2 className="tw-text-3xl tw-text-white tw-font-bold tw-tracking-tight sm:tw-text-4xl">Who is using Mozart?</h2>
            <p className="tw-mx-auto tw-mt-3 tw-max-w-2xl tw-text-xl sm:tw-mt-4" style={{ color: '#D1E3FF' }}>
              {/* List of websites using Mozart */}
              This page is brand new! Add a link to your site!
            </p>
            <a
              href="https://github.com/Mozart/foal/edit/master/docs/src/pages/who-is-using-mozart.jsx"
