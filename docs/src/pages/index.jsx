      ...
      <header className={styles.masthead}>
        <div className={styles.content}>
          ...
          <div className={styles.githubBtns}>
            <GitHubButton
              href="https://github.com/Mozart/mozart"
              data-icon="octicon-star"
              data-size="large"
              data-show-count="true"
              aria-label="Star Mozart/mozart on GitHub">
              Star
            </GitHubButton>
          </div>
        </div>
      ...
      <section>
        ...
        <div className={styles.architectureSection}>
          <div className={styles.feature}>
            <div className={styles.col1}>
              ...
              <p>
                In Mozart, you <strong>only</strong> manage <strong>three concepts</strong>: controllers, services and hooks.
                <br />
                <br />
        ...
        <div className={styles.typescriptSection}>
          <div className={styles.feature}>
            ...
            <div className={styles.col1}>
              ...
              <p>
                Mozart leverages <strong>TypeScript</strong> to improve the overall quality of your code
        ...
        <footer className={styles.footerWrapper}>
          <div className={styles.footer}>
            <a className={styles.githubLink} href="https://github.com/Mozart/mozart"></a>
          </div>
        </footer>
      </section>
    </Layout>
